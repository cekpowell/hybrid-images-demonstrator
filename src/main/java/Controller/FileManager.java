...
public class FileManager {
    ...
    /**
     * Gathers a file object from the local computer by displaying a FileChooser
     * window.
     * 
     * @param window The window the FileChooser will be associated with.
     * @param title The title for the FileChooser window .
     * @return The file selected by the user. Null if no file was selected.
     */
    public static File openFile(String title, Window window, ExtensionFilter[] extensionFilters){
     ...
     * 
     * @param file The File object the content is being written to.
     ...
     */
    public static void writeContentToFile(File file, byte[] content) throws Exception{
        try{
    ...
    public static void writeContentToFile(File file, String content) throws Exception{
        ...
        FileManager.writeContentToFile(file, content.getBytes());
    }
     ...
     */
    public static void writeContentToNewFile(byte[] content, Window window, String initialFileName, ExtensionFilter[] extensionFilters) throws Exception{
        // gathering file
    ...
    public static void writeContentToNewFile(String content, Window window, String initialFileName, ExtensionFilter[] extensionFilters) throws Exception{
        ...
        FileManager.writeContentToNewFile(content.getBytes(), window, initialFileName, extensionFilters);
    }
